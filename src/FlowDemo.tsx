...
const FOX_FACE_PNG_URL = new URL("../iphone_ui_kit/Untitled.png", import.meta.url)
  .href;

function FoxFace({ size = 48 }: { size?: number }) {
  return (
    <img
      src={FOX_FACE_PNG_URL}
      width={size}
      height={size}
      alt="Лис Толя"
...
function ScreenCart({ onCheckout }: { onCheckout: () => void }) {
  return (
    <div className="iphone__screen iphone__screen--cart iphone__screen--locked">
      ...
      <button
        type="button"
        className="m-cta m-cta--gold m-cta--attention m-cta--cart cart-flow__cta"
        onClick={onCheckout}
      >
